...
#
#     def test_3(self) -> None:
#         self.assertAlmostEqual(newton(lambda y: Bond.from_rate(100, 0.07, 2, 3).present_worth(y) - 100, 0.1), 0.07)
#         self.assertAlmostEqual(Bond.from_rate(100, 0.04, 2, 3).present_worth(0.05) + 100 * 0.04 / 2, 99.24593731921009)
#         self.assertAlmostEqual(newton(lambda y: Bond.from_rate(100, 0.03, 2, 2.25).present_worth(y) - 100, 0.1), 0.03)
#         self.assertAlmostEqual(Bond.from_rate(100, 0.07, 2, 2.25).present_worth(0.05), 104.20662940110009)
#         self.assertAlmostEqual(newton(lambda c: Bond.from_rate(100, c, 2, 2.25).present_worth(0.03) - 114, 0.1),
#                                0.09481118)
#
...
#
#     def test_5(self) -> None:
#         y = newton(lambda y: Bond.from_rate(100, 0.07, 2, 7.5).present_worth(y) * fp(y / 2, 0.5) - 108, 0.1)
#
